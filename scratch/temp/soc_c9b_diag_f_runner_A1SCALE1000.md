...
- criteria_failures: `['/health failed: <urlopen error [WinError 10061] No connection could be made because the target machine actively refused it>']`
- exception: `/health failed: <urlopen error [WinError 10061] No connection could be made because the target machine actively refused it>`
...
- report_json: `scratch\temp\soc_c9b_diag_f_runner_A1SCALE1000.json`
- report_md: `scratch\temp\soc_c9b_diag_f_runner_A1SCALE1000.md`
