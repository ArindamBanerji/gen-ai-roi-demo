...
GRAPH_CONTRACT = {
    "nodes": {
        ...
        # Stage 1 planted multi-hop positive-control nodes.  These are optional
        # demo fixtures; min_count=0 keeps the production graph contract stable.
        "AuthTrail": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "distinct_hosts", "failed_then_success"]},
        "Process": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "image", "parent", "signed"]},
        "Host": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "hostname", "criticality"]},
        "EmploymentContext": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "status", "termination_date"]},
        "PeerCohort": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "p95_access_volume", "role"]},
        "CloudResource": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "resource_id", "resource_type"]},
        "ChangeRequest": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "approved", "window_id"]},
        "ScannerInventory": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "scanner_id", "approved"]},
        "Group": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "name", "privilege"]},
        "Role": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "name", "permissions"]},
        "MaintenanceWindow": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "active", "approved"]},
        "AccessKey": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "age_days", "rotation_status"]},
        "ApiSequence": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "sequence", "risk"]},
        "CVE": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "cve_id", "severity"]},
        "CommandProfile": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "baseline", "deviation"]},
        "Credential": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "kind", "risk"]},
        "DeployRecord": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "version", "status"]},
        "DeviceSession": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "device_id", "managed"]},
        "Identity": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "identity_id", "kind"]},
        "Mailbox": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "mailbox_id", "sensitivity"]},
        "ScheduledJob": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "job_id", "owner"]},
        "ServiceAccount": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "account_id", "owner"]},
        "Session": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "source", "sanctioned"]},
        "SoftwarePackage": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "package", "version"]},
        "TimeWindow": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "start", "end"]},
        "TransferHistory": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "bytes", "destination"]},
        "TravelRecord": {"min_count": 0, "required_fields": [], "optional_fields": ["id", "origin", "source", "destination"]},
    },
    "edges": {
        ...
        # Stage 1 planted multi-hop positive-control edges. Optional in production.
        "AFFECTS":             {"min_count": 0, "from": "Alert", "to": "User"},
        "TARGETS":             {"min_count": 0, "from": "Alert", "to": "Asset"},
        "HAS_AUTH_TRAIL":      {"min_count": 0, "from": "User", "to": "AuthTrail"},
        "OBSERVED_PROCESS":    {"min_count": 0, "from": "Alert", "to": "Process"},
        "ORIGINATED_FROM":     {"min_count": 0, "from": "Alert", "to": "Session"},
        "HAS_SESSION":         {"min_count": 0, "from": "User", "to": "Session"},
        "HAS_EMPLOYMENT_CONTEXT": {"min_count": 0, "from": "User", "to": "EmploymentContext"},
        "MEMBER_OF_COHORT":    {"min_count": 0, "from": "User", "to": "PeerCohort"},
        "COVERED_BY_CHANGE":   {"min_count": 0, "from": "Alert", "to": "ChangeRequest"},
        "COVERED_BY_DEPLOY":   {"min_count": 0, "from": "Alert", "to": "DeployRecord"},
        "COMPARED_AGAINST":    {"min_count": 0, "from": "Alert", "to": "PeerCohort"},
        "HAS_COMMAND_PROFILE": {"min_count": 0, "from": "ServiceAccount", "to": "CommandProfile"},
        "HAS_TRAVEL_RECORD":   {"min_count": 0, "from": "User", "to": "TravelRecord"},
        "MATCHES_CVE":         {"min_count": 0, "from": "SoftwarePackage", "to": "CVE"},
        "NESTED_IN":           {"min_count": 0, "from": "Group", "to": "Group"},
        "BINDS_ROLE":          {"min_count": 0, "from": "Group", "to": "Role"},
        "OBSERVED_IN_WINDOW":  {"min_count": 0, "from": "Alert", "to": "TimeWindow"},
        "OBSERVED_SEQUENCE":   {"min_count": 0, "from": "Alert", "to": "ApiSequence"},
        "RUNS_JOB":            {"min_count": 0, "from": "ServiceAccount", "to": "ScheduledJob"},
        "RUNS_PACKAGE":        {"min_count": 0, "from": "Asset", "to": "SoftwarePackage"},
        "USES_CREDENTIAL":     {"min_count": 0, "from": "Alert", "to": "Credential"},
        "USES_KEY":            {"min_count": 0, "from": "ServiceAccount", "to": "AccessKey"},
    },
    "invariants": [
        {
