...
// Provenance: default "context" - this endpoint returns novelty detection output.
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            <div className="rounded border border-gray-800 bg-slate-950/60 p-4">
              ...
              <div className="mt-2 flex items-center gap-2 font-mono text-2xl text-gray-100">
                <span>{percent(data.novelty_rate)}</span>
            ...
            <div className="rounded border border-gray-800 bg-slate-950/60 p-4">
              ...
              <div className="mt-2 flex items-center gap-2 font-mono text-2xl text-gray-100">
                <span>{numberValue(data.novelty_count)?.toLocaleString() ?? 'Unavailable'}</span>
                <ProvenanceBadge source={provenance} />
              </div>
            </div>
            <div className="rounded border border-gray-800 bg-slate-950/60 p-4">
              ...
              <div className="mt-2 flex items-center gap-2 font-mono text-2xl text-gray-100">
                <span>{numberValue(data.distance_threshold)?.toFixed(2) ?? 'Unavailable'}</span>
                <ProvenanceBadge source={provenance} />
              </div>
            </div>
          </div>
